...
type GetThemeScaleValues<T extends keyof ITheme> = 'colors' extends T ? ColorType : ResponsiveValue<keyof ITheme[T] | (string & {}) | (number & {})>;
type GetRNStyles<key, scale = null> = scale extends keyof ITheme ? GetThemeScaleValues<scale> : key extends keyof CSSProperties ? ResponsiveValue<CSSProperties[key]> : key extends keyof RNStyles ? ResponsiveValue<RNStyles[key]> : unknown;

...
export type IModalComponentType = ((props: IModalProps & {
    ref?: MutableRefObject<any>;
}) => JSX.Element) & {
    Body: React.MemoExoticComponent<(props: InterfaceBoxProps<IModalProps> & {
    ...
    Content: React.MemoExoticComponent<(props: InterfaceBoxProps<IModalProps> & {
        ref?: MutableRefObject<any>;
    }) => JSX.Element>;
    Footer: React.MemoExoticComponent<(props: InterfaceBoxProps<IModalProps> & {
        ref?: MutableRefObject<any>;
    }) => JSX.Element>;
    Header: React.MemoExoticComponent<(props: InterfaceBoxProps<IModalProps> & {
        ref?: MutableRefObject<any>;
    }) => JSX.Element>;
};

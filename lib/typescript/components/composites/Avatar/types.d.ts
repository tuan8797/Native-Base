...
export interface IAvatarBadgeProps extends InterfaceBoxProps<IAvatarBadgeProps> {
}
...
export type IAvatarComponentType = ((props: IAvatarProps & {
    ref?: MutableRefObject<any>;
}) => JSX.Element) & {
    Group: React.MemoExoticComponent<(props: IAvatarGroupProps & {
        ref?: MutableRefObject<any>;
    }) => JSX.Element>;
    Badge: React.MemoExoticComponent<(props: IAvatarBadgeProps & {
        ref?: MutableRefObject<any>;
    }) => JSX.Element>;
};

...
export interface InterfaceFormControlProps extends InterfaceBoxProps<IFormControlProps> {
    /**
...
export type FormControlComponentType = ((props: IFormControlProps) => JSX.Element) & {
...
export type IFormControlProps = InterfaceFormControlProps & CustomProps<'FormControl'>;

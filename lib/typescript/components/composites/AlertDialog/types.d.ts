...
import type { CustomProps, ThemeComponentSizeType } from '../../../components/types/utils';
export interface InterfaceAlertDialogProps extends InterfaceBoxProps<IAlertDialogProps> {
    /**
...
export type IAlertDialogComponentType = ((props: IAlertDialogProps & {
    ref?: MutableRefObject<any>;
}) => JSX.Element) & {
    Body: React.MemoExoticComponent<(props: IBoxProps & {
        ref?: MutableRefObject<any>;
    }) => JSX.Element>;
    CloseButton: React.MemoExoticComponent<(props: IIconButtonProps & {
        ref?: MutableRefObject<any>;
    }) => JSX.Element>;
    Content: React.MemoExoticComponent<(props: IBoxProps & {
        ref?: MutableRefObject<any>;
    }) => JSX.Element>;
    Footer: React.MemoExoticComponent<(props: IBoxProps & {
        ref?: MutableRefObject<any>;
    }) => JSX.Element>;
    Header: React.MemoExoticComponent<(props: IBoxProps & {
        ref?: MutableRefObject<any>;
    }) => JSX.Element>;
};
export type IAlertDialogProps = InterfaceAlertDialogProps & CustomProps<'AlertDialog'>;

...
export interface InterfacePressableProps<T = IPressableProps> extends PressableProps, StyledProps, PlatformProps<T> {
    /**
...
export type IPressableProps = InterfacePressableProps<IPressableProps> & CustomProps<'Pressable'>;

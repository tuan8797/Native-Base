...
import type { CustomProps, ResponsiveValue, ThemeComponentSizeType } from '../../../components/types';
...
export interface ICheckboxGroupProps extends InterfaceBoxProps<ICheckboxGroupProps> {
    /**
...
export type ICheckboxComponentType = ((props: ICheckboxProps) => JSX.Element) & {
    Group: React.MemoExoticComponent<(props: ICheckboxGroupProps, ref?: MutableRefObject<any>) => JSX.Element>;
};

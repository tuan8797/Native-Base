...
export interface ISliderTrackFilledProps extends InterfaceBoxProps<ISliderTrackFilledProps> {
    /** Whether the whole Slider is readonly. */
    isReadOnly?: boolean;
    /** Props applied if isDisabled is true. */
    _disabled?: any;
...
export type ISliderComponentType = ((props: ISliderProps & {
    ref?: MutableRefObject<any>;
}) => JSX.Element) & {
    Thumb: React.MemoExoticComponent<(props: ISliderThumbProps & {
        ref?: MutableRefObject<any>;
    }) => JSX.Element>;
    Track: React.MemoExoticComponent<(props: ISliderTrackProps & {
        ref?: MutableRefObject<any>;
    }) => JSX.Element>;
    FilledTrack: React.MemoExoticComponent<(props: ISliderTrackFilledProps & {
        ref?: MutableRefObject<any>;
    }) => JSX.Element>;
};

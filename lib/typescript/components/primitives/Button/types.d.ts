...
import type { ThemeComponentSizeType, CustomProps, VariantType } from '../../../components/types/utils';
import type { ISpinnerProps } from '../Spinner/types';
import type { IIconProps } from '../Icon';
import type { InterfacePressableProps } from '../Pressable/types';
import type { ColorSchemeType } from '../../../components/types';
export interface InterfaceButtonProps extends InterfacePressableProps<IButtonProps> {
    /**
...
export interface IButtonGroupProps extends IStackProps {
     ...
     * @default 'solid'
     */
    variant?: ResponsiveValue<'ghost' | 'outline' | 'solid' | 'link' | 'unstyled' | 'subtle'>;
    /**
     * The start icon element to use in the button.
     */
...
export type IButtonComponentType = ((props: IButtonProps & {

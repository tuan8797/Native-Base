...
const baseStyle = props => {
  ...
  return {
    ...
    onTrackColor: mode(Platform.OS !== 'ios' ? `${colorScheme}.300` : `${colorScheme}.500`, Platform.OS !== 'ios' ? `${colorScheme}.700` : `${colorScheme}.500`)(props),
    onThumbColor: mode(Platform.OS !== 'ios' ? `${colorScheme}.600` : 'white', Platform.OS !== 'ios' ? `${colorScheme}.500` : 'white')(props),

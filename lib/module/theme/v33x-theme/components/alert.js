...
function getBg(props) {
  ...
  const lightBg = variant === 'solid' ? getColor(theme, `${colorScheme}.600`, colorScheme) : getColor(theme, `${colorScheme}.100`, colorScheme);
  const darkBg = variant === 'solid' ? getColor(theme, `${colorScheme}.700`, colorScheme) : getColor(theme, `${colorScheme}.200`, colorScheme);
...
const variantSubtle = props => {
  ...
  return {
    bg: getBg(props),
    _icon: {
      color: mode(`${colorScheme}.600`, `${colorScheme}.700`)(props)
    }
  };
};
...
const variantOutlineLight = props => {
  ...
  return {
    borderWidth: 1,
    borderColor: transparentize(mode(`${colorScheme}.600`, `${colorScheme}.500`)(props), 0.2)(theme),
    _icon: {

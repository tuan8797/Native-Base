...
const RadioComponent = /*#__PURE__*/memo( /*#__PURE__*/forwardRef((_ref, ref) => {
  ...
  const [, cleanInputProps] = extractInObject(inputProps, [...stylingProps.margin, ...stylingProps.layout, ...stylingProps.flexbox, ...stylingProps.position, ...stylingProps.background, ...stylingProps.padding, ...stylingProps.border, '_text']);

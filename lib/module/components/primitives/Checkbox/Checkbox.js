...
const Checkbox = (_ref2, ref) => {
  ...
  useCheckboxGroupItem(combinedProps, checkboxGroupContext.state,
  //@ts-ignore
  mergedRef) :
  // eslint-disable-next-line react-hooks/rules-of-hooks
  useCheckbox(combinedProps, state,
  //@ts-ignore
  mergedRef);
...
const CheckboxComponent = /*#__PURE__*/React.memo(_ref3 => {
  ...
  const [accessibilityProps, nonAccessibilityProps] = extractInObject(nonLayoutProps, ['accessibilityRole', 'accessibilityState', 'accessibilityLabel', 'accessibilityHint']);

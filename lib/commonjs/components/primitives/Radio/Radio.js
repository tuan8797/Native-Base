...
const RadioComponent = /*#__PURE__*/(0, _react.memo)( /*#__PURE__*/(0, _react.forwardRef)((_ref, ref) => {
  ...
  const {
    ...
    _text,
    ...resolvedProps
  } = (0, _useThemeProps.usePropsResolution)('Radio', {
    ...combinedProps,
    size
  }, {
    isInvalid,
  ...
  const [, cleanInputProps] = (0, _utils2.extractInObject)(inputProps, [..._utils2.stylingProps.margin, ..._utils2.stylingProps.layout, ..._utils2.stylingProps.flexbox, ..._utils2.stylingProps.position, ..._utils2.stylingProps.background, ..._utils2.stylingProps.padding, ..._utils2.stylingProps.border, '_text']);

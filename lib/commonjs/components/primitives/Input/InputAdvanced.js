...
const InputAdvance = (_ref2, ref) => {
  ...
  const resolvedProps = (0, _useThemeProps.usePropsResolution)('Input', {
    ...inputThemeProps,
    ...props
  }, {
  ...
  const [, baseInputProps] = (0, _utils.extractInObject)(nonLayoutProps, ['variant']);

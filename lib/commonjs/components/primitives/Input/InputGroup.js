...
const InputGroup = /*#__PURE__*/(0, _react.memo)( /*#__PURE__*/(0, _react.forwardRef)((_ref, ref) => {
  let {
    children,
    ...props
  } = _ref;
  const [layoutProps, nonLayoutProps] = (0, _utils2.extractInObject)(props, [..._utils2.stylingProps.margin, ..._utils2.stylingProps.border, ..._utils2.stylingProps.layout, ..._utils2.stylingProps.flexbox, ..._utils2.stylingProps.position, ..._utils2.stylingProps.background, 'space', 'shadow', 'opacity']);

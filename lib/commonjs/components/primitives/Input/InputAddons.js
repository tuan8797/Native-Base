...
(0, _react.forwardRef)((props, ref) => {
  const resolvedProps = (0, _usePropsResolution.usePropsResolution)('InputLeftAddon', props);
...
const InputRightAddon = /*#__PURE__*/(0, _react.memo)( /*#__PURE__*/(0, _react.forwardRef)((props, ref) => {
  const resolvedProps = (0, _usePropsResolution.usePropsResolution)('InputRightAddon', props);
  //TODO: refactor for responsive prop
  if ((0, _useHasResponsiveProps.useHasResponsiveProps)(props)) {
    return null;
  }

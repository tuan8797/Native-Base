...
const Checkbox = (_ref2, ref) => {
  ...
  (0, _checkbox.useCheckboxGroupItem)(combinedProps, checkboxGroupContext.state,
  //@ts-ignore
  mergedRef) :
  // eslint-disable-next-line react-hooks/rules-of-hooks
  (0, _checkbox.useCheckbox)(combinedProps, state,
  //@ts-ignore
  mergedRef);
...
const CheckboxComponent = /*#__PURE__*/_react.default.memo(_ref3 => {
  let {
    wrapperRef,
    inputProps,
    combinedProps,
  ...
  const {
    ...
    onBlur,
    ...resolvedProps
  } = (0, _useThemeProps.usePropsResolution)('Checkbox', {
    ...combinedProps,
    ...inputProps
  }, {
    isInvalid,
  ...
  const [accessibilityProps, nonAccessibilityProps] = (0, _utils3.extractInObject)(nonLayoutProps, ['accessibilityRole', 'accessibilityState', 'accessibilityLabel', 'accessibilityHint']);
  ...
  return /*#__PURE__*/_react.default.createElement(_Pressable.Pressable, _extends({
    ...
    onPressOut: (0, _utils2.composeEventHandlers)(onPressOut, pressableProps.onPressOut)
    // @ts-ignore - web only
    ,
    onHoverIn: (0, _utils2.composeEventHandlers)(onHoverIn, hoverProps.onHoverIn)
    // @ts-ignore - web only
    ,
    onHoverOut: (0, _utils2.composeEventHandlers)(onHoverOut, hoverProps.onHoverOut)
    // @ts-ignore - web only
    ,
    onFocus: (0, _utils2.composeEventHandlers)((0, _utils2.composeEventHandlers)(onFocus, focusProps.onFocus)
    // focusRingProps.onFocu
    )
    // @ts-ignore - web only
    ,
    onBlur: (0, _utils2.composeEventHandlers)((0, _utils2.composeEventHandlers)(onBlur, focusProps.onBlur)

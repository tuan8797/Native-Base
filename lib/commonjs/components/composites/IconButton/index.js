...
const IconButton = (_ref, ref) => {
  ...
  const {
    ...
    onBlur,
    ...resolvedProps
  } = (0, _useThemeProps.usePropsResolution)('IconButton', {
    ...props,
    _icon: (0, _lodash.merge)({}, pseudoIconProp, icon === null || icon === void 0 ? void 0 : icon.props)
  }, {
  ...
  let clonedIcon;
  if (icon) {
    clonedIcon = /*#__PURE__*/_react.default.cloneElement(icon, {
      ..._icon
    });
  }

...
const Content = /*#__PURE__*/(0, _react.memo)( /*#__PURE__*/(0, _react.forwardRef)((_ref, ref) => {
  let {
    hideDragIndicator,
    children,
    handleClose,
...
const ActionsheetContent = (_ref2, ref) => {
  ...
  const handleCloseCallback = _react.default.useCallback(handleClose, [_Context.ModalContext, handleClose]);

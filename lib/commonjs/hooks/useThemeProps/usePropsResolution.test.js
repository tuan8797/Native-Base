...
function _extends() { _extends = Object.assign ? Object.assign.bind() : function (target) { for (var i = 1; i < arguments.length; i++) { var source = arguments[i]; for (var key in source) { if (Object.prototype.hasOwnProperty.call(source, key)) { target[key] = source[key]; } } } return target; }; return _extends.apply(this, arguments); } // import { Ionicons } from '@expo/vector-icons';
...
describe('props resolution', () => {
  ...
  it('HStack: style props test on ios & dark mode', () => {
    ...
    const {
      ...
      theme: newTheme
    }, /*#__PURE__*/_react.default.createElement(_primitives.Box, null, /*#__PURE__*/_react.default.createElement(_primitives.Text
    // @ts-ignore
    , {
      fontSize: "12px",
      testID: "test",
  ...
  it('Heading: style props test on ios with dark mode', () => {
    ...
    const {
      ...
      theme: newTheme
    }, /*#__PURE__*/_react.default.createElement(_primitives.Box, null, /*#__PURE__*/_react.default.createElement(_primitives.Heading
    // @ts-ignore
    , {
      fontSize: "12px",
      testID: "test",

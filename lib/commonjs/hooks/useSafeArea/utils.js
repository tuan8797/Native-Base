...
function getValueInPixels(paddingProps, paddingKeys, sizes, inset, manualInset) {
  ...
  if (!(0, _lodash.isNil)(manualInset) && typeof manualInset !== 'boolean') {
...
function calculatePaddingTop(safeAreaProps, paddingProps, insets, sizes) {
  if ((0, _lodash.isNil)(safeAreaProps.safeArea) && (0, _lodash.isNil)(safeAreaProps.safeAreaTop) && (0, _lodash.isNil)(safeAreaProps.safeAreaY)) {
    return;
  }
...
function calculatePaddingBottom(safeAreaProps, paddingProps, insets, sizes) {
  if ((0, _lodash.isNil)(safeAreaProps.safeArea) && (0, _lodash.isNil)(safeAreaProps.safeAreaBottom) && (0, _lodash.isNil)(safeAreaProps.safeAreaY)) {
    return;
  }
...
function calculatePaddingLeft(safeAreaProps, paddingProps, insets, sizes) {
  if ((0, _lodash.isNil)(safeAreaProps.safeArea) && (0, _lodash.isNil)(safeAreaProps.safeAreaLeft) && (0, _lodash.isNil)(safeAreaProps.safeAreaX)) {
    return;
  }
...
function calculatePaddingRight(safeAreaProps, paddingProps, insets, sizes) {
  if ((0, _lodash.isNil)(safeAreaProps.safeArea) && (0, _lodash.isNil)(safeAreaProps.safeAreaRight) && (0, _lodash.isNil)(safeAreaProps.safeAreaX)) {
    return;
  }
  // DOC: Adding it for manual inset passed by the user

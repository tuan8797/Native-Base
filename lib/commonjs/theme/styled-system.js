...
exports.typography = exports.space = exports.propConfig = exports.position = exports.layout = exports.getStyleAndFilteredProps = exports.getColor = exports.flexbox = exports.color = exports.border = exports.background = void 0;
var _reactNative = require("react-native");
var _lodash = require("lodash");
var _tools = require("./tools");
var _getStyledFromProps = require("../utils/getStyledFromProps");
var _convertStringNumberToNumber = require("../utils/convertStringNumberToNumber");
...
const getColor = (rawValue, scale, theme) => {
  ...
  if (alphaMatched) {
    ...
    const alphaFromToken = (0, _lodash.get)(theme.opacity, alphaValue, alphaValue);
    const alpha = alphaFromToken ? parseFloat(alphaFromToken) : 1;
    const newColor = (0, _tools.transparentize)(color, alpha)(theme);
    return newColor;
  } else {
    return (0, _lodash.get)(scale, rawValue, rawValue);
  }
};
...
const getMargin = (n, scale) => {
  n = (0, _convertStringNumberToNumber.convertStringNumberToNumber)('margin', n);
  if (!isNumber(n)) {
    return (0, _lodash.get)(scale, n, n);
  }
  const isNegative = n < 0;
  const absolute = Math.abs(n);
  const value = (0, _lodash.get)(scale, absolute, absolute);
  if (!isNumber(value)) {
...
const typography = {
  ...
  fontWeight: {
    ...
    transformer: (val, scale) => {
      return val ? (0, _lodash.get)(scale, val, val).toString() : val;
    }
  },
  lineHeight: {
    property: 'lineHeight',
...
const getStyleAndFilteredProps = _ref => {
  let {
    style,
    theme,
    debug,
  ...
  let {
    styleFromProps,
    responsiveStyles
  } = (0, _getStyledFromProps.getStyledFromProps)(styledSystemProps, theme, currentBreakpoint, propConfig);
  if (responsiveStyles) {
    const query = {
      query: []
    };

...
const baseStyle = props => {
  ...
  return {
    ...
    onTrackColor: (0, _tools.mode)(_reactNative.Platform.OS !== 'ios' ? `${colorScheme}.300` : `${colorScheme}.500`, _reactNative.Platform.OS !== 'ios' ? `${colorScheme}.700` : `${colorScheme}.500`)(props),
    onThumbColor: (0, _tools.mode)(_reactNative.Platform.OS !== 'ios' ? `${colorScheme}.600` : 'white', _reactNative.Platform.OS !== 'ios' ? `${colorScheme}.500` : 'white')(props),
